...
window.openSpinWheel = function() {
    ...
    // ✅ لو لف قبل كده — بيان مقفول بس مش بيتمنع
    if (wheelData.used) {
        controls.innerHTML = `
            <div style="text-align:center;margin-top:8px;">
                <p style="font-family:'Cairo',sans-serif;color:#9ca3af;font-size:13px;font-weight:700;margin-bottom:8px;">
                    لفتها قبل كده! 🔒
                </p>
                <p style="font-family:'Cairo',sans-serif;color:#4b5563;font-size:11px;">
                    انتظر التحديث القادم من الأدمن عشان تلف تاني
                </p>
            </div>`;
    } else {
        // ✅ لسه ملفش — اعرضله الزرار مباشرة بدون شرط
